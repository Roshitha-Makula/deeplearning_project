...
EvalDatasetConfigDict = {
    EvalDatasetType.EC: {"dt": 0.010, "root_dir": "/student/tahmad8/Videos/deep_ev_tracker/ec_subseq/"},
    # EvalDatasetType.EDS: {"dt": 0.005, "root_dir": "/student/tahmad8/Videos/deep_ev_tracker/eds_subseq/"},
}
...
EVAL_DATASETS = [
    ...
    ("space_simulated", EvalDatasetType.EC)
]
