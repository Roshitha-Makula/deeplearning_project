...
corrected_image_dir = f"/student/tahmad8/Videos/deep_ev_tracker/eds_subseq/ziggy_in_the_arena_1350_1650/images_corrected"
image_ts_path = f"/student/tahmad8/Videos/deep_ev_tracker/eds_subseq/ziggy_in_the_arena_1350_1650/images_timestamps.txt"
corrected_events_path = (
    f"/student/tahmad8/Videos/deep_ev_tracker/eds_subseq/ziggy_in_the_arena_1350_1650/events_corrected.h5"
)
dt_event_slice = 500
...
with h5py.File(corrected_events_path, "r") as h5f:
    ...
    for image_idx, image_p in enumerate(
        ...
        plt.pause(0.0001)
        plt.clf()
        plt.savefig(f"/student/tahmad8/Videos/deep_ev_tracker/eval_results/images/{image_idx}.png")
        # plt.show()
